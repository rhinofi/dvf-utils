...
const assertConsistentWithBfx = price => {
...
const testValue = (priceIn, priceOut) => {
  ...
  assertConsistentWithBfx(priceIn)
}
...
describe('prepareAmount', () => {
  it('rounds provided number (or numeric string) to 8 decimal places by default, and returns it as a string', () => {
    testValue(1, '1')
    testValue(0.5, '0.5')
    testValue(0.6, '0.6')
