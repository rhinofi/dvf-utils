...
describe('Joi', () => {
  ...
  describe('price', () => {
    ...
    it('should truncate excess digits', () => {
      const result = schema.validate('250.12345678')
      expect(result).toEqual({ value: '250.12345' })
    })
  })
  ...
  describe('amount', () => {
    ...
    it('should truncate excess digits', () => {
      const result = schema.validate('0.1234567899')
      expect(result).toEqual({ value: '0.12345678' })
    })
  })
})
